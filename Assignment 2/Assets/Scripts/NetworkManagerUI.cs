...
public class NetworkManagerUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // add a listener to the host button
        host_mouse_btn.onClick.AddListener(() =>
        {
            // call the NetworkManager's StartHost() method
            // NetworkManager.Singleton.StartHost();
            StartHostRelay(false);
        });
    ...
    // Start host relay
    public async void StartHostRelay(bool setIsCat)
    {
        host_btn.gameObject.SetActive(false);
        host_mouse_btn.gameObject.SetActive(false);
